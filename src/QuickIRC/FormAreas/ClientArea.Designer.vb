...
Partial Class ClientArea
    ...
    Private Sub InitializeComponent()
        ...
        Me.UserChatView = New QuickIRC.UserChatView()
        Me.ChannelChatView = New QuickIRC.ChannelChatView()
        Me.ServerChatView = New QuickIRC.ServerChatView()
        Me.RawChatView = New QuickIRC.RawChatView()
